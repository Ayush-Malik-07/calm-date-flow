    ...
    extend: {
      colors: {
        ...
        dashboard: {
          ...
          "accent-hover": "hsl(var(--dashboard-accent-hover))",
          border: "hsl(var(--dashboard-border))",
          glass: "hsl(var(--dashboard-glass))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": {
            boxShadow: "0 0 5px hsl(var(--dashboard-accent))",
          },
          "50%": {
            boxShadow: "0 0 20px hsl(var(--dashboard-accent)), 0 0 30px hsl(var(--dashboard-accent))",
          },
        },
      },
      animation: {
